  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm flex-1 max-w-[2.5rem] focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day: cn(
          ...
          "w-full h-8 p-0.5 font-normal aria-selected:opacity-100"
        ),
        day_range_start:
